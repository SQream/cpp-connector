...
TEST_CASE("explicit_connection_disconnection") {
...
TEST_CASE("multiple_nvarchar_column") {
...
TEST_CASE("int_insert_positive_test") {
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    auto nrows = 3;
...
TEST_CASE("float_insert_positive_test") {
...
TEST_CASE("bool_insert_positive_test") {
...
TEST_CASE("date_insert_positive_test") {
...
TEST_CASE("datetime_insert_positive_test") {
...
/*
TEST_CASE("time_insert_positive_test) {
    run_direct_query(&sqc, "create or replace table t (x datetime not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    auto nrows = 2;
...
TEST_CASE("varchar_insert_positive_test") {
...
TEST_CASE("nvarchar_insert_positive_test") {
    run_direct_query(&sqc, "create or replace table t (x nvarchar(10) not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    auto nrows = 3;
...
TEST_CASE("nvarchar_insert_positive_test_big") {
    run_direct_query(&sqc, "create or replace table t (x nvarchar(10) not null)");
    new_query_execute(&sqc, "insert into t values (?)");
...
/*
TEST_CASE("get_chunk_size_positive_test) {
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    auto nrows = 5;
    int vals[] {1, 2, 3, 4, 5};
...
TEST_CASE("get_columns_info_positive_test") {
...
// TEST DEFAULT
TEST_CASE("int_insert_default_positive_test") {
    auto nrows = 3;
    int vals[] {INT_MAX, INT_MIN, 0};
...
TEST_CASE("varchar_insert_default_positive_test") {
    int nrows = 3;
    int vals[] {INT_MAX, INT_MIN, 0};
...
// TEST IDENTITY
TEST_CASE("int_insert_identity_positive_test") {
    auto nrows = 3;
    int vals[] {INT_MAX, INT_MIN, 0};
    int identity = 17;
...
TEST_CASE("driver_internal_struct_coverage") {
...
TEST_CASE("negative_testing_types_not_null") {
...
/*
TEST_CASE("negative_testing_type_date_not_null) {
    run_direct_query(&sqc, "create or replace table t (x date not null)");
    new_query_execute(&sqc, "insert into t values (?)");
...
TEST_CASE("negative_testing_type_datetime_not_null) {
    run_direct_query(&sqc, "create or replace table t (x datetime not null)");
    new_query_execute(&sqc, "insert into t values (?)");
...
TEST_CASE("negative_testing_type_varchar_not_null") {
    run_direct_query(&sqc, "create or replace table t (x varchar(10) not null)");
...
TEST_CASE("negative_testing_type_nvarchar_not_null") {
    run_direct_query(&sqc, "create or replace table t (x nvarchar(10) not null)");
...
TEST_CASE("all_types_with_nulls") {
...
TEST_CASE("all_types_with_nulls_named_col") {
...
TEST_CASE("negative_testing_next_row_column_count")
{
...
TEST_CASE("negative_testing_prepare_column_count")
{
    run_direct_query(&sqc, "create or replace table t (x int not null, y int not null)");
    try
    {
...
// set wrong INDEX
TEST_CASE("negative_testing_set_wrong_index")
{
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    sqc.set_int(0, 1);
...
// set wrong NAME
//TEST_CASE("negative_testing_set_wrong_name)
//{
//    run_direct_query(&sqc, "create or replace table t (x int not null)");
//    new_query_execute(&sqc, "insert into t values (?)");
//    try
...
// get wrong INDEX
TEST_CASE("negative_testing_get_wrong_index")
{
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    sqc.set_int(0, 0);
...
// get wrong NAME
TEST_CASE("negative_testing_get_wrong_name")
{
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    int val = rand();
...
TEST_CASE("negative_testing_get_in_insert")
{
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "insert into t values (?)");
    sqc.set_int(0, 1);
...
// call set function in the middle of select statement
TEST_CASE("negative_testing_set_in_select")
{
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    new_query_execute(&sqc, "select * from t");
    try
...
TEST_CASE("negative_testing_prepare_statement_mismatch_in_param")
{
    run_direct_query(&sqc, "create or replace table t (x int not null)");
    try
    {
...
TEST_CASE("negative_testing_int_insert_overwrite") {
...
TEST_CASE("negative_testing_int_insert_null_overwrite") {
...
TEST_CASE("negative_testing_too_many_next_row_calls_on_select") {
    run_direct_query(&sqc, "create or replace table t(x int)");
    new_query_execute(&sqc, "insert into t values (?)");
    sqc.set_int(0,666);
    sqc.next_query_row();
